...
function createFileInput(accept, changeHandler) {
...
function triggerImageUpload() {
    const input = createFileInput('image/*', handleImageFile);
    input.click();
}
...
function triggerDocUpload() {
    const input = createFileInput('.pdf,.docx,.xlsx,.pptx,.txt,.csv', handleDocFile);
    input.click();
}
